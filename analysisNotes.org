...
** HW 11 - due Friday 10/28

   5,6,7,11, extra credit 21, 22
...
** We may as well cover this now - Monotonic Functions
...
** More on monotone functions

   monotonically increasing - x < y -> f(x) .LEQ. f(y)
